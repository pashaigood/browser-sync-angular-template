...
var plugin = {
  ...
  "plugin": angularTemplate/*function (opts, _instance_) {
    var logger = _instance_.getLogger(PLUGIN_NAME);
    angularTemplate.setInstance(_instance_);
    angularTemplate.setLogger(logger);
    logger.info("Running...");
  }*/,
  "hooks": {
    "client:js": "",
    //"client:events": function () {
    //  return angularTemplate.TEMPLATE_CHANGE_EVENT;
    //},
